...
const Tips = () => {
  ...
  useEffect(() => {
    fetch("https://api.quotable.io/random?tags=health|wisdom|inspirational")
      .then((res) => res.json())
      .then((data) => {
  ...
  return (
    <div className="home-container">
      ...
      <section className="home-section">
        <h2>Daily Tips</h2>
        <p>
          Our Daily Tips is to help individuals achieve mental clarity, emotional
          resilience, and a balanced life through daily mindful practices and
          guided habits.
        </p>
      </section>
